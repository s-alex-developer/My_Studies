...
2. Итераторы (цикл for и реализация через ООП).
3. Итератор через функцию генератор.
***
...
```
    ...
    <generator object generate at 0x000001CAC80FE810>
...
**>>> СУПЕР ГЕРОИ. Реализация через функцию-генератор:**
